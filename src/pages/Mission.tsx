...
const Mission = () => {
  return (
    <section className="min-h-screen w-full bg-[#4B9CD3] pt-32 pb-16 overflow-y-auto flex items-center justify-center relative">
      <div className="w-full max-w-5xl mx-auto">
        <div className="bg-white/10 backdrop-blur-md rounded-3xl p-12 sm:p-16 border border-white/20 shadow-2xl shadow-black/10 hover:bg-white/15 transition-all duration-300">
          ...
          <div className="space-y-12">
            {missionAreas.map((area, idx) => (
              <div key={idx} className="">
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-semibold mb-4 text-white/90">
                  {area.title}
                </h3>
